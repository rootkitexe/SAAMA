            ...
            <div className="mx-auto max-w-2xl">
                <div className="mb-8 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-serif font-bold text-[#5c3a1e] flex items-center gap-3">
                            <UserIcon className="h-8 w-8 text-[#3d230d]" /> User Profile
                        </h1>
                        <p className="text-[#7a5c3a] mt-2">Please complete your profile before registering for competitions.</p>
                    </div>
                    <a href="/portal" className="inline-flex items-center justify-center gap-2 text-sm font-bold text-[#3d230d] bg-white px-5 py-2.5 rounded-lg border border-[#d4c4a8] hover:bg-[#f0ebe0] transition-colors shadow-sm">
                        ← Back to Dashboard
                    </a>
                </div>
                ...
                <div className="bg-white/80 border border-[#d4c4a8] rounded-xl p-8 shadow-sm space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" value={profile.email} disabled className="w-full rounded-lg bg-[#f0ebe0] border border-[#d4c4a8] text-[#7a5c3a] p-2.5 cursor-not-allowed" />
                    </div>

                    <div>
                        <label className="block text-sm font-bold text-[#5c3a1e] mb-1">Full Name *</label>
                        <input type="text" name="full_name" value={profile.full_name} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]" placeholder="As it should appear on certificates" />
                    </div>

                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-bold text-[#5c3a1e] mb-1">Birthday *</label>
                            <input type="date" name="birthday" value={profile.birthday} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]" />
                        </div>
                        <div>
                            <label className="block text-sm font-bold text-[#5c3a1e] mb-1">Age as of May 1</label>
                            <div className="flex items-center gap-3">
                                <input type="text" value={age !== null ? `${age} years` : '—'} disabled className="flex-1 rounded-lg bg-[#f0ebe0] border border-[#d4c4a8] text-[#5c3a1e] p-2.5 cursor-not-allowed font-bold" />
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="sex" value={profile.sex} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]">
                        ...
                        <div>
                            ...
                            <input type="tel" name="mobile" value={profile.mobile} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]" placeholder="(555) 123-4567" />
                        </div>
                    </div>

                    <div>
                        <label className="block text-sm font-bold text-[#5c3a1e] mb-1">Address</label>
                        <input type="text" name="address" value={profile.address} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]" placeholder="Street address" />
                    </div>

                    <div className="grid grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-bold text-[#5c3a1e] mb-1">City</label>
                            <input type="text" name="city" value={profile.city} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]" />
                        </div>
                        <div>
                            <label className="block text-sm font-bold text-[#5c3a1e] mb-1">State</label>
                            <input type="text" name="state" value={profile.state} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]" maxLength={2} placeholder="WA" />
                        </div>
                        <div>
                            <label className="block text-sm font-bold text-[#5c3a1e] mb-1">Zip</label>
                            <input type="text" name="zip" value={profile.zip} onChange={handleChange} className="w-full rounded-lg bg-white border border-[#d4c4a8] text-[#5c3a1e] p-2.5 focus:ring-[#3d230d] focus:border-[#3d230d]" />
                        </div>
                    </div>
